package com.tutorialsninja.commons;
...
import com.tutorialsninja.reports.ReportsClass;
import com.tutorialsninja.utilities.ReadProp;
...
public class WebCommons {
	...
	// perform mouse hover action from one element from other element
	public void mouseHover(WebElement element) {
		Actions action = new Actions(driver);
		action.moveToElement(element).perform();
	}

	// perform mouse hover action and click operation from one element from other
	// element
